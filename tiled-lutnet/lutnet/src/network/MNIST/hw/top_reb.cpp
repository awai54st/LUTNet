...
#include <ap_int.h>
#include"weights_reb.h"
#include "bnn-reb-library.h"
#include "config.h"
...
//    );
  ...
  LUTNET_REBMV_TM<
    L3_iR, L3_iC, L3_N, L3_oR, L3_oC, L3_M, L3_K, L3_ST, L3_BW, 24, 16, L3_TN, L3_TM,
    hls::stream<data_t_L3>,
  ...
  LUTNET_REBMV_TM_NOTH<
    L5_iR, L5_iC, L5_N, L5_oR, L5_oC, L5_M, L5_K, L5_ST, L5_BW, 24, 16, OutputWidth_val, L5_TN, L5_TM,
    hls::stream<data_t_L5>,
